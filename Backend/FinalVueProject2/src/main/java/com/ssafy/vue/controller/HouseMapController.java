...
public class HouseMapController {
	...
	public ResponseEntity<List<HouseInfoDto>> aptRanking(
			@RequestParam(value="dongCode", required = true) String dongCode,
			@RequestParam(value="key", required = false) String key,
			 @RequestParam("lat") String lat,
			 @RequestParam("lng") String lng) throws Exception {
		return new ResponseEntity<List<HouseInfoDto>>(haHouseMapService.getAptRankInDong(dongCode, key, lat, lng), HttpStatus.OK);
	}
